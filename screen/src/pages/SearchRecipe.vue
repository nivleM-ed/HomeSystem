<template>
  ...
  <card>
    ...
    <form>
      ...
      <div v-if="error" style="background-color: #edd2d1" class="border border-danger rounded mt-3 p-2 text-center">
        <h4 slot="header" class="card-title">{{error}}</h4>
        <p v-if="error=='Network Error'">If you see this, it means there is a problem with reaching the server</p>
